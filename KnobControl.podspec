...
Pod::Spec.new do |s|
  ...
  s.name         = "KnobControl"
  s.version      = "1.0.0"
  s.summary      = "s.summary description"
  ...
  s.homepage     = "https://www.ekwing.com"
  ...
  s.author             = { "lcjingdi" => "lcjingdi@gmail.com" }
  # Or just: s.author    = "lcjingdi"
  # s.authors            = { "lcjingdi" => "lcjingdi@gmail.com" }
  # s.social_media_url   = "http://twitter.com/lcjingdi"
...
# s.source       = {:path => '.'}
s.source        = {:git => "https://github.com/lcjingdi/KnobControl.git", :tag => "1.0.0"}
